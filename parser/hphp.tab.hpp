...
#define YYTOKEN(num, name) name = num,
   ...
   YYTOKEN_MAP
  {
    ...
    YYTOKEN(355, T_STATIC)
    YYTOKEN(356, T_ABSTRACT)
    YYTOKEN(357, T_FINAL)
    YYTOKEN(358, T_PRIVATE)
    YYTOKEN(359, T_PROTECTED)
    YYTOKEN(360, T_PUBLIC)
    YYTOKEN(361, T_VAR)
    YYTOKEN(362, T_UNSET)
    YYTOKEN(363, T_ISSET)
    YYTOKEN(364, T_EMPTY)
    ...
    YYTOKEN(375, T_DICT)
    YYTOKEN(376, T_VEC)
    YYTOKEN(377, T_KEYSET)
    YYTOKEN(378, T_CALLABLE)
    YYTOKEN(379, T_CLASS_C)
    YYTOKEN(380, T_METHOD_C)
    YYTOKEN(381, T_FUNC_C)
    YYTOKEN(382, T_LINE)
    YYTOKEN(383, T_FILE)
    YYTOKEN(384, T_COMMENT)
    YYTOKEN(385, T_DOC_COMMENT)
    YYTOKEN(386, T_OPEN_TAG)
    YYTOKEN(387, T_OPEN_TAG_WITH_ECHO)
    YYTOKEN(388, T_CLOSE_TAG)
    YYTOKEN(389, T_WHITESPACE)
    YYTOKEN(390, T_START_HEREDOC)
    YYTOKEN(391, T_END_HEREDOC)
    YYTOKEN(392, T_DOLLAR_OPEN_CURLY_BRACES)
    YYTOKEN(393, T_CURLY_OPEN)
    YYTOKEN(394, T_DOUBLE_COLON)
    YYTOKEN(395, T_NAMESPACE)
    YYTOKEN(396, T_NS_C)
    YYTOKEN(397, T_DIR)
    YYTOKEN(398, T_NS_SEPARATOR)
    YYTOKEN(399, T_XHP_LABEL)
    YYTOKEN(400, T_XHP_TEXT)
    YYTOKEN(401, T_XHP_ATTRIBUTE)
    YYTOKEN(402, T_XHP_CATEGORY)
    YYTOKEN(403, T_XHP_CATEGORY_LABEL)
    YYTOKEN(404, T_XHP_CHILDREN)
    YYTOKEN(405, T_ENUM)
    YYTOKEN(406, T_XHP_REQUIRED)
    YYTOKEN(407, T_TRAIT)
    YYTOKEN(408, T_ELLIPSIS)
    YYTOKEN(409, T_INSTEADOF)
    YYTOKEN(410, T_TRAIT_C)
    YYTOKEN(411, T_HH_ERROR)
    YYTOKEN(412, T_FINALLY)
    YYTOKEN(413, T_XHP_TAG_LT)
    YYTOKEN(414, T_XHP_TAG_GT)
    YYTOKEN(415, T_TYPELIST_LT)
    YYTOKEN(416, T_TYPELIST_GT)
    YYTOKEN(417, T_UNRESOLVED_LT)
    YYTOKEN(418, T_COLLECTION)
    YYTOKEN(419, T_SHAPE)
    YYTOKEN(420, T_TYPE)
    YYTOKEN(421, T_UNRESOLVED_TYPE)
    YYTOKEN(422, T_NEWTYPE)
    YYTOKEN(423, T_UNRESOLVED_NEWTYPE)
    YYTOKEN(424, T_COMPILER_HALT_OFFSET)
    YYTOKEN(425, T_ASYNC)
